"""fansnime_backend URL Configuration
...
urlpatterns = [
    ...
    path('api/film_jenis/<slug:jenis>/', views.film_jenis),
    path('api/film_keyword/<slug:keyword>/', views.film_keyword),
    ...
    # API Additional
    path('api/suggest/', views.searchsuggest),
