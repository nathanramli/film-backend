...
class  CharaList  extends  Component {
  ...
  handleCreate(){
    ...
    let url = 'http://localhost:8000/api/chara/';
    axios.post(url, form_data, {
      ...
      let charaBaru = {
        ...
        foto: 'http://localhost:8000' + result.data.foto,
        pk: result.data.pk
      }
  ...
  render() {
    ...
    return (
      <div>
          ...
          <Dialog open={this.state.open} onClose={this.toggleClose.bind(this)}>
            <form onSubmit={this.handleSubmit.bind(this)}>
            <DialogTitle>Tambah character</DialogTitle>
            <DialogContent>
